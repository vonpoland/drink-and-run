...
import {moveOnTileStrategy, chaseObjectStrategy, randomMoveStrategy, findOtherWayStrategy} from './game/moveStrategies';
import {MOVES} from './game/base/moveableGameObject';
	...
	TopDownGame.Game.prototype = {
		...
		create: function () {
			...
			this.policeman = createMoveableObject(this.game, {
				...
				layer: MOVE_PARAMS.layer,
				target: this.player,
				onBlock: findOtherWayStrategy,
				moveStrategies: [chaseObjectStrategy, randomMoveStrategy]
			});
